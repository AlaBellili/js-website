...
let productsInFavorite = localStorage.getItem("FavoriteItems")
...
if (productsInFavorite) {
    let item = JSON.parse(productsInFavorite)
...
function removeFromFavotite (id) {
    if(productsInFavorite) {
        ...
        localStorage.setItem ('productsInFavorite' , JSON.stringify(filterItem))
